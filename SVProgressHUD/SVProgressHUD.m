...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _infoImage = [UIImage imageNamed:@"info.png" inBundle:imageBundle compatibleWithTraitCollection:nil];
        _successImage = [UIImage imageNamed:@"success.png" inBundle:imageBundle compatibleWithTraitCollection:nil];
        _errorImage = [UIImage imageNamed:@"error.png" inBundle:imageBundle compatibleWithTraitCollection:nil];
